...
/**
 * This exception is thrown when there is an error when one is saving data to a path
 *
 * @author Patrick Chan
 */
public class SaveErrorException extends Exception {

    /** The path that resulted in a {@link SaveErrorException} */
    private Path path;
    ...
    /**
     * Creates an instance of the SaveErrorException class that takes a {@link Path} parameter which specifies the path
     ...
     */
    public SaveErrorException(Path path, String reason) {
        this.path = path;
        this.reason = reason;
    }
